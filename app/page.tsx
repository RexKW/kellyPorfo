...
export default function Home() {
  return (
    <div className="flex min-h-screen bg-white bg-cover bg-center bg-no-repeat bg-[url(/home/homeBG.png)] relative items-center justify-center overflow-hidden">
      ...
      <Image src={'/home/clover.png'} alt="clover" className="absolute z-2 left-[-25%] lg:left-[-5%] w-[200px] lg:w-[450px] top-[-5%] lg:top-[-10%]" width={500} height={500}/>
      ...
      <Image src={'/home/graphicDesignStar.svg'} alt="starGraphDes" className="absolute z-1 left-[-20%] lg:left-[-5%] bottom-[-10%] lg:bottom-[-20%]" width={600} height={600}/>
      ...
      <img src={'/home/thePortfolioAsset.png'} alt="portfo" className="absolute z-2 w-[900px] h-auto"/>
