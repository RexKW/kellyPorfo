    ...
    <div className="flex flex-col bg-white relative">
      <div className="flex flex-col justify-center bg-[#f5b0c7] items-center relative">
        <div className="flex-flex-col justify-center items-center relative z-1">
          ...
          <div className="bg-[#f5b0c7] w-full h-[45vh] lg:h-[50vh] justify-center items-center relative">
            <img src="/mainWork/monelieGreen.svg" className="absolute left-[50%] translate-x-[-50%] z-2 w-[50%] translate-y-[-75%]" alt="" />
      ...
      <div className="flex flex-col bg-white justify-center items-center relative h-[200px] lg:h-screen w-full">
        <div className="flex flex-row px-10  w-full h-[100px] lg:h-full">
          <div className="basis-1/6 h-full flex items-start"><img src="/mainWork/monelieAsset1.svg" className="w-[75%]" alt="" /></div>
            <div className="basis-1/6 h-full flex items-end"><img src="/mainWork/monelieAsset2.svg" className="w-[75%]" alt="" /></div>
            <div className="basis-1/6 h-full flex items-start"><img src="/mainWork/monelieAsset3.svg" className="w-[75%]" alt="" /></div>
            <div className="basis-1/6 h-full flex items-end"><img src="/mainWork/monelieAsset4.svg" className="w-[75%]" alt="" /></div>
            <div className="basis-1/6 h-full flex items-start"><img src="/mainWork/monelieAsset5.svg" className="w-[75%]" alt="" /></div>
            <div className="basis-1/6 h-full flex items-end"><img src="/mainWork/monelieAsset6.svg" className="w-[75%]" alt="" /></div>
        </div>
      ...
      <div className="flex relative flex-col h-screen bg-white overflow-hidden">
        ...
        <img src="/mainWork/monelieBanners.png" className="w-[60%] absolute top-[50%] translate-y-[-50%] left-25" alt="" />
        <img src="/mainWork/bgMonelieBanner.png" className="w-screen h-full absolute top-0  left-0" alt="" />
        <img src="/mainWork/cornerAssetMonelie.svg" className="w-[25%] h-auto absolute top-0 right-0" alt="" />
        <img src="/mainWork/bottomCornerMonelie.svg" alt="" className="w-[20%] absolute bottom-[-5%] right-[-5%]" />
      </div>
      <div className="flex flex-col justify-center items-center h-screen">
          <img src="/mainWork/monelieStand.png" className="w-[50%]" alt="" />
      </div>
