...
export default function JonBakery() {
  return (
    <div className='flex flex-col bg-white relative'>
      ...
      <div className="flex flex-col bg-white justify-center items-center relative h-[40vh] lg:h-screen w-full">
        <div className="flex flex-row w-full gap-5 w-[75vw] justify-start items-center h-[40vh] lg:h-full">
        ...
        <img src="/mainWork/bakery/phoneBakery.png" alt="" className='right-0 absolute h-full w-auto z-10 bottom-0' />
      </div>
