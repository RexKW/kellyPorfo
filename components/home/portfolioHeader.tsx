...
export default function PortfolioHeader() {
  return (
      <div className="flex z-2 w-screen h-[350px]  md:h-[800px] lg:min-h-[130vh] bg-white bg-cover bg-center bg-no-repeat bg-[url(/home/homeBG.png)] relative items-center justify-center overflow-hidden">
